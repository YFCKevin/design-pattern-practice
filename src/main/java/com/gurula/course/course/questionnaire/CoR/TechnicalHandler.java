...
public class TechnicalHandler extends ResponseHandler{
    private final FAQRepository faqRepository;
    public TechnicalHandler(ResponseHandler next, FAQRepository faqRepository) {
        super(next);
    ...
    protected boolean match(QuestAnswerType type) {
        return QuestAnswerType.TECHNICAL.equals(type);
    }
